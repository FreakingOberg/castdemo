package se.systemagic.android.castdemo.utils;
...
import se.systemagic.android.castdemo.CastApplication;
...
//                .setIcon(R.drawable.ic_action_alerts_and_states_warning)
    ...
    public static void handleException(Context context, Exception e) {
        ...
        if (resourceId > 0) {
            se.systemagic.android.castdemo.utils.Utils.showOopsDialog(context, resourceId);
        }
    }
