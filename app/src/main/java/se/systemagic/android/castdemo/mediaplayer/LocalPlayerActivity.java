...
package se.systemagic.android.castdemo.mediaplayer;
...
import se.systemagic.android.castdemo.browser.VideoProvider;
import se.systemagic.android.castdemo.utils.Utils;
    ...
    */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (null != b) {
            ...
            Log.d(TAG,"Setting videoView url to :" + mSelectedMedia.getContentId());
        ...
        switch (state) {
            case PLAYING:
                ...
                mPlayPause.setImageDrawable(
                        ContextCompat.getDrawable(this, R.drawable.ic_av_pause_dark));
            ...
            case PAUSED:
                ...
                mPlayPause.setVisibility(View.VISIBLE);
                mPlayPause.setImageDrawable(
                        ContextCompat.getDrawable(this, R.drawable.ic_av_play_dark));
                mPlayCircle.setVisibility(isConnected ? View.VISIBLE : View.GONE);
                break;
            case BUFFERING:
    ...
    private void setCoverArtStatus(String url) {
        if (null != url) {
            Log.d(TAG,"Trying to fetch img: " + url );
